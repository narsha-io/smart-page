...
public class WebConfig implements WebMvcConfigurer {
    ...
    @Autowired
    private PaginatedFilteredQueryResolver paginatedFilteredQueryResolver;
    ...
    public class PaginatedFilterControllerAdvice {
        ...
        protected ResponseEntity<String> handleHttpRequestMethodNotSupportedException(UnknownFilterException e) {
